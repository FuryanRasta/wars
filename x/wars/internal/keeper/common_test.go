...
func getValidPowerFunctionWar() types.War {
	functionType := types.PowerFunction
	functionParams := functionParametersPower()
	reserveTokens := powerReserves()
	return types.NewWar(initToken, initName, initDescription, initCreator,
...
func getValidAugmentedFunctionWar() types.War {
...
func getValidSwapperWar() types.War {
