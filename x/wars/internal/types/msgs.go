...
func (msg MsgCreateWar) ValidateBasic() error {
	...
	// Check that war token is a valid token name
...
func (msg MsgCreateWar) Route() string { return RouterKey }

func (msg MsgCreateWar) Type() string { return TypeMsgCreateWar }
...
func (msg MsgEditWar) Route() string { return RouterKey }

func (msg MsgEditWar) Type() string { return TypeMsgEditWar }
...
func (msg MsgSwap) ValidateBasic() error {
	...
	} else if strings.TrimSpace(msg.WarToken) == "" {
		return sdkerrors.Wrap(ErrArgumentCannotBeEmpty, "WarToken")
...
func (msg MsgMakeOutcomePayment) ValidateBasic() error {
	...
	// Validate war token
	err := CheckCoinDenom(msg.WarToken)
	if err != nil {
		return err
	}
